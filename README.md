...
```bash
git clone https://github.com/FendiMohamed/nextjs-eks-infra-observability.git
cd terraform
```
...
```bash
aws eks --region us-west-2 update-kubeconfig --name fendi-eks-obs
```
...
> > - **GitHub Repo URL:** `https://github.com/<your user-name/repo`<br/>
>
> > In **Trigger**<br/>
...
> > - **SCM:** `Git`<br/>
> > - **Repository URL:** `https://github.com/<your user-name/repo`<br/>
...
```bash
aws eks update-kubeconfig --region us-west-2 --name fendi-eks-obs
```
